return {
  ...
  dependencies = {
    ...
    "moll/vim-bbye", -- For Bdelete command
  },
  ...
  keys = {
    ...
    -- { "<leader>sf", "<cmd>SessionManager load_current_dir_session<cr>", desc = "Load current directory session" },
    -- { "<leader>st", "<cmd>SessionManager load_last_session<cr>", desc = "Load last session" },
  },
  config = function()
